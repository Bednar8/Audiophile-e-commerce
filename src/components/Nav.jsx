...
function Nav() {
	...
	return (
		<>
			<div className="fixed inset-0 z-40 h-max">
				<nav className="fixed flex justify-between text-white h-[100px] mx-7 border-b-[1px] border-b-[#979797] max-sm:w-full max-sm:m-0 z-40 bg-black-secondary">
					<button
